...
<body>
    ...
    <div x-data="{ activeTab: 'vols' }">
        ...
        <div class="form-container">
            <!-- Formulaire Vols -->
            <form x-show="activeTab === 'vols'" x-data="{ typeVol: '{{ old('type', 'Aller simple') }}' }" method="POST" action="{{ route('reservation.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" x-model="typeVol">
                        <option value="Aller simple" {{ old('type') == 'Aller simple' ? 'selected' : '' }}>Aller simple</option>
                        <option value="Aller-retour" {{ old('type') == 'Aller-retour' ? 'selected' : '' }}>Aller-retour</option>
                        <option value="Multi-destinations" {{ old('type') == 'Multi-destinations' ? 'selected' : '' }}>Multi-destinations</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="class" name="class">
                        <option value="Economique" {{ old('class') == 'Economique' ? 'selected' : '' }}>Économique</option>
                        <option value="Premium" {{ old('class') == 'Premium' ? 'selected' : '' }}>Premium</option>
